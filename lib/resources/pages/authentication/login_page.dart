            ...
            children: [
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text("Selamat Datang,", style: context.textTheme.headlineMedium!.copyWith(fontWeight: FontWeight.bold)),
                            Text("Silahkan login terlebih dahulu", style: context.textTheme.headlineSmall!.copyWith(color: Colors.grey[800])),
                          ],
                        ),
                      ),
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text('Belum punya akun?', style: context.textTheme.bodyLarge),
                    const SizedBox(width: 4),
                    GestureDetector(
                      onTap: () {
                        Get.toNamed('register-page');
                      },
                      child: Text('Daftar', style: context.textTheme.bodyLarge!.copyWith(fontWeight: FontWeight.bold)),
                    ),
                  ],
                ),
              ),
